...
%ddllt curve
for indx = 1:5
file = build_ddllt_data_file_name_without_indx( N(indx),tau,dg(indx));
file = [path file];
...
%lt curve
for indx = 1:5
file = build_lt_data_file_name_without_indx( N(indx),tau);
file = [path file];
